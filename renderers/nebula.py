...
from npython import *
import os.path
from pyui2 import rendererBase, desktop
import pyui2
def orig():
...
class RendererNeb(rendererBase.RendererBase):
    ...
    def mouseMotion(self,x,y):
        pyui2.desktop.getDesktop().postUserEvent(pyui2.locals.MOUSEMOVE,self.mouseX, self.mouseY)
        self.mouseX = x
        self.mouseY = y

    def mouse1down(self):
        pyui2.desktop.getDesktop().postUserEvent(pyui2.locals.RMOUSEBUTTONDOWN, self.mouseX, self.mouseY)

    def mouse1up(self):
        pyui2.desktop.getDesktop().postUserEvent(pyui2.locals.RMOUSEBUTTONUP, self.mouseX, self.mouseY)

    def mouse0down(self):
        pyui2.desktop.getDesktop().postUserEvent(pyui2.locals.LMOUSEBUTTONDOWN, self.mouseX, self.mouseY)

    def mouse0up(self):
        pyui2.desktop.getDesktop().postUserEvent(pyui2.locals.LMOUSEBUTTONUP, self.mouseX, self.mouseY)
    ...
    def doRect(self, color, (x,y,w,h), windowPos):
        ...
        self.pyui2.doRect(x1,y2,x2,y1,color[0],color[1],color[2],color[3])
    ...
    def doGradient(self, (x,y,w,h), c1,c2,c3,c4, windowPos):
        ...
        self.pyui2.doGradient(x1,y2,x2,y1,c1[0],c1[1],c1[2],c1[3],c2[0],c2[1],c2[2],c2[3],c4[0],c4[1],c4[2],c4[3],c3[0],c3[1],c3[2],c3[3])
    ...
    def doLine(self, x1,y1,x2,y2, color, windowPos):
        ...
        self.pyui2.doLine(X1,Y1,X2,Y2,color[0],color[1],color[2],color[3])
    ...
    def doText(self, text, (x,y), (r,g,b,a), font, windowPos):
        ...
        self.pyui2.doText(text, x1,-y1,r,g,b,a)
    ...
    def loadImage(self, filename, label=None):
        ...
        self.pyui2.loadImage(filename,label,0)
    ...
    def doImage(self, (x,y,w,h), name, windowPos):
        ...
        self.pyui2.doImage(label,x1,y1,x2,y2)

    def load1(self):
        self.loadImage("/home/washort/nebula-build/pyui2/tests/max.bmp","max.bmp")

    def test1(self):
        self.drawRect((10,10,50,50),(1,0,0,1))
        self.drawImage((60,50,100,100),"/home/washort/nebula-build/pyui2/tests/max.bmp")

    def load2(self):
        self.loadImage("/home/washort/nebula-build/pyui2/tests/folder.bmp","folder.bmp")
        
    def test2(self):
        self.drawImage((300,200,100,100),"/home/washort/nebula-build/pyui2/tests/folder.bmp")
        
    def test3(self):
        self.drawImage((500,100,100,100),"/home/washort/nebula-build/pyui2/tests/max.bmp")
