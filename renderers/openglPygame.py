...
import pyui2
import pygame
from pyui2.renderers import openglBase
from pygame import locals

from pyui2.desktop import getDesktop, getTheme, getRenderer
...
class OpenGLPygame(openglBase.OpenGLBase):
	...
	def update(self):
		...
		while event.type != locals.NOEVENT:
			...
			# special case to handle multiple mouse buttons!
				...
				#    desktop.postUserEvent(pyui2.locals.CHAR, 0, 0, character, pygame.key.get_mods())
	...
	def loadTexture(self, filename, label = None):
		...
		try:
			...
			surface = pygame.image.load(  pyui2.__path__[0] + "/images/" + filename )
