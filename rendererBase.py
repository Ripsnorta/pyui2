...
class RendererBase:
    ...
    are created, and tracks the list of draw primitives for each window. This is for 2D only.
    """
    name = "Base"
    ...
    def drawImageRotated(self, rect, filename, rotDegrees, textureEffect):
        ...
        #print "Rotation or Texture Effects unimplemented on this renderer!  Fix in pyui2!"
