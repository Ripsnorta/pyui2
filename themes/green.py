...
class GreenTheme(ThemeBase):
    ...
    def drawFrame(self, rect, title, backImage):
        ...
        self.renderer.drawRect(pyui2.colors.green, rect)
        self.renderer.drawRect(pyui2.colors.black, (rect[0]+2, rect[1]+2, rect[2]-4, rect[3]-4) )
        ...
        hitList.append((pyui2.locals.HIT_FRAME_MOVE, (x,y,w,h)))
        ...
        hitList.append((pyui2.locals.HIT_FRAME_CLOSE, (x,y,w,h)))
